...
#    Updated: 2025/05/22 23:02:49 by abisiani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC=ft_isalpha.c ft_toupper.c ft_tolower.c ft_isdigit.c ft_isalnum.c \
	...
	ft_strncmp.c ft_memchr.c ft_memcmp.c ft_strnstr.c  ft_calloc.c #ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c
